    ...
    try:
        while saved_episodes < cfg.dataset.num_episodes:
            ...
            if recording_interrupted_by_exit_early:
                ...
                logger.info(
                    "✅ RECORDING PHASE COMPLETED - full duration reached, proceeding to save episode"
                )
                print(f"✅ STATUS CHANGE: Recording timeout reached for episode {current_episode} - saving")
